...
var app = (function () {
    ...
    /* src/KonvaDrawer.svelte generated by Svelte v3.8.1 */

    const file = "src/KonvaDrawer.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c: function create() {
    			div1 = element("div");
    			div0 = element("div");
    			attr(div0, "id", "konva-stage");
    			add_location(div0, file, 351, 4, 9764);
    			add_location(div1, file, 350, 0, 9754);
    		},
    ...
    onMount(() => {
        ...
        // then create layer
        var layer = new lib.Layer();
        var tooltipLayer = new lib.Layer();

        var tooltip = new lib.Label({
            opacity: 0.75,
            visible: false,
            listening: false
          });
    ...
    class KonvaDrawer extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_fragment$1(ctx) {
    	...
    	var konvadrawer = new KonvaDrawer({ $$inline: true });

    	return {
    		c: function create() {
    			div = element("div");
    			konvadrawer.$$.fragment.c();
    			add_location(div, file$1, 10, 0, 181);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			mount_component(konvadrawer, div, null);
    			current = true;
    		},
    		...
    		i: function intro(local) {
    			if (current) return;
    			transition_in(konvadrawer.$$.fragment, local);

    			current = true;
    		},

    		o: function outro(local) {
    			transition_out(konvadrawer.$$.fragment, local);
    			current = false;
    		},
